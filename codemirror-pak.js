if (window.oncodemirrorPAK)
  window.oncodemirrorPAK();

function codemirrorPAK(window, document, getText, setText) {




// from codemirror.net/codemirror.js
...
// from http://codemirror.net/mode/markdown/markdown.js
...
var codemirrorStyle = document.createElement('style');
setText(codemirrorStyle, getText(codemirrorCSS));
document.body.appendChild(codemirrorStyle);


// from http://codemirror.net/lib/codemirror.css (with comments cut out)
